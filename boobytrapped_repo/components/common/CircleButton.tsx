...
export const CircleButton = styled.button.attrs<CircleButtonProps>(
    ({ small, smaller, outline, ui, button, borderless }) => ({
        className: clsx({ small, smaller, outline, borderless }),
    }),
)<CircleButtonProps>`
    flex: 0 0 48px;
    width: 48px;
