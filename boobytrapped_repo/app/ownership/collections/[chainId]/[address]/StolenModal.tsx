...
const StolenModal: React.FC<TransferModalProps> = ({
    isOpen,
    setIsOpen,
    address,
    tokenId,
    ...
    const sendRequest: any = async () => {
        const type = CampaignType.STOLE;
                ...
                <>
                    <Header>
                        <div className="img-wrapper">
                            <Image
                                src="/images/campaigns/stole.svg"
                                width={50}
                                height={50}
                                alt={""}
                            />
                        ...
                        <Spacer y size={3} />
                        <div className="text">
                            Would you like to report it as stolen?
                        </div>
                        <Spacer y size={3} />
                    </Header>
                    <Accept>
            ...
            {status === true && (
                <>
                    <Header>
                        ...
                        <Spacer y size={3} />
                        <div className="text">
                            Your item has been reported as stolen.
                        </div>
                        <Spacer y size={2} />
                        The &quot;Stolen&quot; label will be displayed in your
                        Digital Passport
                        <Spacer y size={5} />
                    </Header>
                </>
